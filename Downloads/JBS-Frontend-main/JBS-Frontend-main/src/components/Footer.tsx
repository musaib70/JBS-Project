  ...
  return (
    <footer className="bg-black text-white mt-10  ">
      <div className="p-6 py-20 md:px-4 lg:px-4 xl:px-8 2xl:px-16">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-4 gap-8 ">
          ...
          <div>
            ...
            <p className="text-sm ">KSA Office</p>
            <p className="text-sm">
            ...
            <p className="text-sm mt-4">Pakistan Office</p>
            <p className="text-sm">
          ...
          <div className=" flex flex-row justify-between md:px-8 align-bottom">
            <div>
              ...
              <ul className="space-y-2 text-sm mb-6">
                <li><Link href="/about-us">Who Are We</Link></li>
      ...
      {showBackToTop && (
        <button
          onClick={scrollToTop}
          className="fixed max-md:mr-3 bottom-6 z-10 right-6 bg-gradient-to-r from-[#1da692] to-[#4355a1] text-white font-bold w-[60px] h-[60px] rounded-full shadow-lg hover:bg-gray-200 transition duration-300"
        >
          ↑
        </button>
      )}
